...
/*   Updated: 2024/02/08 17:59:53 by amarna           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* Reply to PING with a PONG using the client's nickname. */
...
/* Close socket, remove client from pool and notify departure. */
...
/* Register client's username, mode, hostname and realname from USER command args. */
...
/* Validate and assign a new nickname to the client. */
...
/* Check client password against server password, reject if mismatch or already registered. */
...
/* Strip trailing \r from each token (IRC lines end with \r\n, read strips \n but not \r). */
...
/* Join a channel: create it if it doesn't exist, otherwise add client to existing one. */
...
/* Handle MODE command: verify client is a channel operator before applying mode changes. */
