...
/* Parse a raw NICK/USER string and populate the client's fields accordingly. */
...
/* Print a connection confirmation message with client info. */
void client::hello()
{
	std::cout	<< GREEN
...
/* Print a disconnection message with client info. */
void client::goodBy()
{
